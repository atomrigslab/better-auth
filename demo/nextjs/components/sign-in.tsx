...
export default function Login() {
  ...
  const connectGoogleFromWalletUser = async () => {
    await linkSocial({
      provider: "google", // Provider to link
      callbackURL: "/link-success",
    });
  ...
  const connectEmailFromWalletUser = async () => {
    // render email inputs
    // update email
    // email verification
    // google
  ...
  return (
    <>
      ...
      <div className="w-full max-w-md space-y-4">
        ...
        {/* Ronin Wallet Button */}
        <button
          className="w-full bg-gray-900 hover:bg-gray-800 text-white rounded-lg p-4 flex items-center transition"
          onClick={props.connectGoogleFromWalletUser}
        >
          <div className="mr-4">
