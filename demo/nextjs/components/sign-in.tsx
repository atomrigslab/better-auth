    ...
    <Card className="max-w-md rounded-none">
      ...
      <CardContent>
        <div className="grid gap-4">
          ...
          >
            {loading ? <Loader2 size={16} className="animate-spin" /> : "Send Email"}
          </Button>
          ...
          <Button
            ...
            onClick={async () => {
              try {
                ...
                console.log("emailOtp result", { data, error });
              } catch (error) {
                console.error(error);
              }
            }}
          ...
          >
            {loading ? <Loader2 size={16} className="animate-spin" /> : "Sign In With Ronin"}
          </Button>
